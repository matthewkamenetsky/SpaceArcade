 ...
 * Description: The Coin class is responsible for updating the coins in the space run game; it is a child of the SpaceObject class.
 */
...
namespace SpaceArcade
{
    class Coin : SpaceObject
    {
        ...
        private const int WIDTH_TOL = 10;
        ...
        //Post: none
        //Desc: sets up the Coin object with necessary values
        public Coin(Texture2D objectImg, Texture2D blankTexture, Vector2 animPos, float speed) : base(objectImg, blankTexture, animPos, speed)
        {
            //Setup the Coin's animation and create its hitbox
        ...
        //Post: none
        //Desc: updates the movement of the Coin
        public override void Update(GameTime gameTime)
        {
            //Update the base elements of the space object
            base.Update(gameTime);

            //Set the coin's hitbox position
